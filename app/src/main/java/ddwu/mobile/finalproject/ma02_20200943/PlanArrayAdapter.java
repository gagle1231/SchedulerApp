...
public class PlanArrayAdapter extends BaseAdapter {
    ...
    public PlanArrayAdapter(Context context, int layout, ArrayList<Plan> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        tvDate.setText(String.valueOf(dto.getYear())+"/"+String.valueOf(dto.getMonth())+"/"+String.valueOf(dto.getDay()));
